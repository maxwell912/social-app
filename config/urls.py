...
urlpatterns = [
    ...
    path('reactions/', include(('apps.reactions.urls', 'reaction'), namespace='reactions')),
    path('files/', include(('apps.files.urls', 'files'), namespace='files')),
    path('', include(('apps.users.urls', 'users'), namespace='users')),
    path('accounts/', include('allauth.urls')),
    path('', include(('apps.bookmarks.urls', 'bookmarks'), namespace='bookmarks')),
